...
DefaultHandler::DefaultHandler(ISignallingHandler *sigHandler) { _sigHandler = sigHandler; }

DefaultHandler::~DefaultHandler() {}

int DefaultHandler::serve_http(HttpResponseWriter *w, HttpMessage *r) {
    int ret = COCO_SUCCESS;
    coco_dbg("get http req. path: %s, method: %s", r->path().c_str(), r->method_str().c_str());
...
PublishHandler::PublishHandler(ISignallingHandler *sigHandler) { _sigHandler = sigHandler; }
...
PlayHandler::PlayHandler(ISignallingHandler *sigHandler) { _sigHandler = sigHandler; }
...
int32_t WebRTCSignalling::HandleUnPublish(HttpResponseWriter *w, HttpMessage *r) { return 0; }
...
int32_t WebRTCSignalling::HandleUnPlay(HttpResponseWriter *w, HttpMessage *r) { return 0; }