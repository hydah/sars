...
WebRTCSignalling::WebRTCSignalling(std::string ip, uint32_t port, std::shared_ptr<RTCServer> rtcServer)
{
...
int32_t WebRTCSignalling::HandleUnPublish(HttpResponseWriter* w, HttpMessage* r)
{
    return 0;
}
